...
# Quid Pro Quo Policy (China Automotive FDI)

**China's industrial policy requiring foreign automakers to transfer technology to domestic joint venture partners in exchange for access to the Chinese passenger car market, enforced from 1984 until the requirement was formally lifted on 1 January 2022.**

## Summary

The quid-pro-quo (QPQ) policy was the central mechanism through which China built its domestic automotive industry. Foreign OEMs wishing to manufacture and sell passenger cars in China were legally required to form 50/50 joint ventures with approved domestic partners — initially exclusively state-owned enterprises. In exchange for accepting a co-owner, foreign firms gained access to one of the world's most important car markets.
...
| Year | Event |
|---|---|
| 1979 | First Law on Sino-Foreign Equity Joint Ventures issued |
| 1984 | SAIC-VW joint venture established — first major auto JV |
| 1994 | Automotive Industry Policy: 50/50 cap + two-JV limit formalized |
| 1997 | SAIC-GM joint venture established |
| 2001 | China joins WTO; non-SOEs allowed to form JVs |
| 2018 | Foreign equity cap loosened from 50% to 70% |
| 2022 (Jan 1) | 50/50 JV requirement and two-JV-per-line limit formally removed |
...
- [[joint-venture-model]] — the structural implementation of QPQ in the auto sector
- [[jv-instability]] — what happens when QPQ rationale dissolves after capabilities are acquired

## Key academic sources

| Author(s) | Title | Journal | Year | ABS |
|---|---|---|---|---|
| Bai, Barwick, Cao, Li | "Quid Pro Quo, Knowledge Spillovers, and Industrial Quality Upgrading: Evidence from the Chinese Auto Industry" | American Economic Review | 2025 | 4* |
| Holmes, McGrattan, Prescott | "Quid Pro Quo: Technology Capital Transfers for Market Access in China" | Review of Economic Studies | 2015 | 4* |
| Howell | "Joint ventures and technology adoption: A Chinese industrial policy that backfired" | Research Policy | 2018 | 3 |
| Thun | "Changing Lanes in China" | Cambridge UP (book) | 2006 | — |

## Related

- [[joint-venture-model]] — the structural vehicle through which QPQ was implemented
- [[saic-motor]] — primary beneficiary of QPQ; two major JVs built on this policy
- [[saic-volkswagen]] — QPQ JV est. 1984
- [[saic-gm]] — QPQ JV est. 1997
- [[state-owned-enterprise]] — Chinese SOEs were the designated QPQ partners
- [[jv-instability]] — theory of why JVs become unstable once knowledge parity is reached
- [[byd-company]] — counter-model: QPQ-free capability building

## Open questions

- Now that QPQ is formally ended, will foreign OEMs seek to buy out their JV partners (full ownership) or exit China?
- Has SAIC retained the technology and capabilities from JV-era production, or was the knowledge transfer insufficient to sustain autonomous competitiveness?
- Does QPQ removal change the strategic calculus for VW and GM in their SAIC JVs, and if so how quickly can legacy JV contracts be renegotiated?
