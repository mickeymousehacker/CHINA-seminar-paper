...
**The tendency of international joint ventures to dissolve or undergo ownership restructuring when shifts in partner bargaining power — driven by asymmetric learning — erode the knowledge-dependency rationale that made the JV mutually beneficial.**
...
- JV instability is driven by asymmetric learning: the JV breaks up when one partner's dependency on the other is eliminated by skill acquisition. [[2026-05-25-saic-motor-sources-web-research]]
- Termination modes differ: unexpected industry growth favors acquisition by one partner; industry decline raises dissolution risk. [[2026-05-25-saic-motor-sources-web-research]]
- Political stability and economic development of the host country shape how JV termination unfolds. [[2026-05-25-saic-motor-sources-web-research]]
- China's regulatory removal of the JV requirement (2022) removes an exogenous constraint that previously stabilized JV structures regardless of learning asymmetry. [[2026-05-25-saic-motor-sources-web-research]]

## Key academic source

| Author(s) | Title | Journal | Year | ABS |
|---|---|---|---|---|
| Inkpen, Beamish | "Knowledge, Bargaining Power, and the Instability of International Joint Ventures" | Academy of Management Review | 1997 | 4* |

## Related

- [[quid-pro-quo-policy]] — the policy context that created China's automotive JVs
- [[joint-venture-model]] — structural implementation
- [[saic-motor]] — firm currently experiencing JV instability dynamics
- [[saic-gm]] — JV showing advanced instability symptoms (−56.54% sales 2024)
- [[saic-volkswagen]] — JV extended to 2040; outcome of stability/renewal unclear

## Open questions

- Has SAIC's learning from JVs been sufficient to sustain independent competitiveness, or did the cannibalization effect prevent adequate capability building?
- Will foreign OEMs (VW, GM) seek to acquire majority control of their JVs now that the 50% cap is lifted, or exit entirely?
