...
- Updated: `research/wiki/saic-motor/index.md`
- Contradictions flagged: NEV-Subventionen = 0 laut AR (S. 21) vs. EU-VO 2024/2754 (SAIC 35,3 % Zoll wegen Subventionen) — interpretierbar, nicht fundamental widersprüchlich; im Conflict-Callout dokumentiert
- Key numbers: Nettogewinn RMB 10,11 Mrd. (+506 %); ROE 3,43 %; NEV 1,643 Mio. (+33 %); SAIC-GM Auslastung 37 %; SAIC-VW 55 %; VW MEB-Werk 14 %; SAIC Group 63,71 %; KPCh-Klausel S. 35; Huawei SHANGJIE H5 Sep. 2025
- Research purpose: Aktuellste Primärquelle (FY2025); Kapazitätsauslastungsdaten sind stärkster quantitativer Beleg für JV-Zerfall; Governance-Klausel wichtigstes Primärzitat für Parteiführungsthese

## [2026-06-03 18:00] refactor | Quellenbereinigung — 4 Quellen entfernt

- Gelöschte Wiki-Seiten: [[2026-06-03-yan-gray-1994-bargaining-power-jv-amj]], [[2026-05-27-bruton-peng-et-al-2015-soe-hybrid-organizations-amp]], [[2026-06-03-dewenter-malatesta-2001-soe-private-firms-aer]], [[2026-05-23-saic-motor-financials-2020-2024]]
- Gelöschte PDFs: Bargaining Power...JVs.pdf (Yan & Gray), STATE-OWNED ENTERPRISES...HYBRID.pdf (Bruton), State-Owned and Privately Owned Firms.pdf (D&M)
- Begründung: Yan & Gray → redundant mit Inkpen & Beamish (1997); Bruton et al. ABS 3 → redundant mit Fan et al. + Shleifer-Vishny; D&M → redundant mit Megginson & Netter (2001); Financials 2020-24 → vollständig im Annual Report 2024 enthalten
- Updated: [[state-owned-enterprise]] (Bruton-Abschnitt entfernt), [[index]] (4 Einträge entfernt)
- Verbleibende Quellen: 15

## [2026-06-03 17:30] ingest | IEA Global EV Outlook 2026 + EU-Verordnung 2024/2754
...
- Key numbers: IEA — China NEV 55 % (2025), 13+ Mio. Verkäufe, CN-Hersteller 60 % global, >90 % Prognose 2035; EU — SAIC 35,3 % vs. BYD 17,0 %, SAIC-VW (89HZ) + SAIC-GM (89IB) explizit benannt (Art. 1, S. 228)
- Research purpose: Marktdaten für Long-term Viability (IEA); primärquellenbasierter Subventionsbeleg für Governance (EU-Verordnung); der SAIC/BYD-Zollvergleich ist stärkster externer Einzelbeleg für staatliche Subventionsabhängigkeit
...
- Updated: `research/wiki/saic-motor/index.md`
- Contradictions flagged: none — complements Megginson & Netter (2001) and D&M (2001); adds foreign > domestic ownership hierarchy and China nuance
- Key findings: Foreign private ownership → large rapid TFP gains; domestic private → smaller/delayed; state → worst; China: mixed, mostly positive but sometimes insignificant/negative; tunneling/looting explains domestic underperformance in weak institutions (pp. 723–724)
- Research purpose: ABS 4* meta-survey for Governance + Financing; explains SAIC-own-brand vs. SAIC-JV performance gap structurally; foreign ownership (VW/GM at JV level) outperforms state ownership (SAIC proper)

## [2026-06-03 15:00] ingest | DeWenter & Malatesta (2001) — SOE vs. Private Firms, AER
...
- Updated: `research/wiki/saic-motor/index.md`
- Contradictions flagged: none — complements Megginson & Netter (2001); D&M shows gains are front-loaded before privatization, MNR shows long-run improvement
- Key numbers: ROS government 0.013 vs. private 0.027; ROE −0.007 vs. 0.089; EBIT no post-priv improvement; leverage −0.087*** post-priv; labor intensity −2.83*** post-priv (Table 4)
- Research purpose: ABS 4* empirical benchmark for Financing dimension; global quantitative grounding for SAIC's ROE collapse; the privatization timing puzzle directly relevant to SAIC reform expectations
...
- Updated: `research/wiki/saic-motor/index.md`
- Contradictions flagged: none — directly extends Inkpen & Beamish (1997) and empirically grounded for U.S.–China context
- Key findings ingested: Ownership ≠ control (p. 1508); Chinese partner goal = technology acquisition (p. 1512); foreign partner must continuously reinvest to preserve bargaining position (p. 1512); shared control outperforms dominant control in developing-country JVs (p. 1510); Prop. 3–5 (trust, objectives, institutionalization as moderators; dynamic bargaining shifts)
- Research purpose: Seminararbeit — empirical anchor for Capability Building and Long-term Viability; explains why SAIC-VW/GM power dynamics work the way they do; pairs with Inkpen & Beamish (1997) as theory + evidence

## [2026-06-03 13:00] ingest | Inkpen & Beamish (1997) — JV Instability, AMR
...
- Research purpose: Standard IB theory for Long-term Viability section; explains SAIC-GM −56.54% strukturell, nicht konjunkturell
